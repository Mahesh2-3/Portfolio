        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 sm:gap-12 gap-8">
          {TECH.map((tech) => (
            ...
            >
              ...
              {/* Actual glass card */}
              <div className="relative sm:transition-transform will-change-transform sm:hover:shadow-[0px_4px_0px_4px_#414141] ease-in-out duration-700 sm:hover:translate-y-[-10px]  w-[120px] h-[120px] rounded-xl border bg-white/10 border-white/20 p-7 flex items-center justify-center">
                <img
                  src={tech.src}
                  alt={tech.name}
                  loading="lazy"
