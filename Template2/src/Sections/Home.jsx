...
const Home = () => {
  return (
    <div className="w-full hero xl:bg-[linear-gradient(110deg,#D7D7D7_50%,#000_50%)] lg:bg-[linear-gradient(110deg,#D7D7D7_45%,#D7D7D7_45%,#000_30%,#000_30%)] bg-black h-screen flex justify-between overflow-hidden relative">
      ...
      <div className="h-full lg:w-[50%] w-full flex items-end justify-end">
        <img
          className="sm:w-[640px] w-full h-[720px] object-contain"
          src="/profile.png"
          alt=""
        />
      </div>
